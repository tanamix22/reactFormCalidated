    ...
    <>
        ...
        <form onSubmit={ handleSubmit(customSubmit) } className='form-react'>
            <div className='form-control'>
                ...
                {errors.name?.type === 'minLength' && <small className='fail'>El minimo de caracteres es 2</small>}
                {errors.name && <p className='fail'>solo se permite letras</p>}
            </div>
            <div className='form-control'>
                <label>Age</label>
            ...
            <div className='form-control'>
                ...
                {errors.email && <p className='fail'>correo no valido</p>}
            ...
            <div className='form-control'>
                ...
                {errors.mensaje && <p className='fail'>El campo no puede estar vacío, max 250</p>}
            </div>
             <div className='form-control'>
